...
*/
function Job(inputFile, options){
    var self = this;
    ...
    Stores `input`, `working`, `archive` and `output` paths
     ...
     @type Object
    */
    this.path = computePaths(inputFile, pathOptions);
    this.valid = validate(this.path);
    this.encoderOptions = {};
...
computePaths.config = function(values){
    return new Config()
