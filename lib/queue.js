...
/**
 The Queue class manages the list of Jobs to process. 
...
module.exports = function Queue(){
    ...
    */
    ...
    /**
     lists what Jobs are on the Queue
     @property jobs
     @type {Object}
    */
    this.jobs = {
...
/**
 Add a file or files to the Queue
 @method add
 @param {String|Array} files File or files to add to the queue
*/
...
/**
used by this.add, with --recurse set
