...
function Config() {
	...
	this.defaultOptions = configFile.defaultOptions;
	this.ignoreList = configFile.ignoreList;
	this.archiveDirectory = configFile.archiveDirectory;
	this.inputFiles = cliArgs.files;
	this.options = _.defaults(cliArgs.options, configFile.defaultOptions);
	this.options = divideOptions(this.options);	
}
