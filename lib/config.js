...
function Config(){
    ...
    */
    this.option = function option(name, definition){
        ...
        if (typeof _definitions[name] !== "undefined"){
            throw new Error("[config.option] option already exists: " + name);
        }
        if (definition.alias && typeof _definitions[definition.alias] !== "undefined"){
            throw new Error("[config.option] alias already exists: " + definition.alias);
        }
    ...
    */
    ...
    /**
     @method set
     @param {Object|String} option Pass a string to set a single value, an object to set multiple values
     @param {Any} value
     @chainable
    */
