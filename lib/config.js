...
// API
exports.definition = _definition;       // for testing purposes
exports.group = group;
...
function reset(){
    exports.definition = _definition = {};
    _currentGroup = "";
    _currentSubGroup = "";
}

function parseCliArgs(optionName){
    optionName = optionName || "inputFiles";
    var args = cliArgs.getArgs();
    group("cli").option(optionName, { type: "array" });
    set(optionName, args.files);
...
function has(option){
    ...
    // specific option
        ...
        return _definition[option] !== undefined;
    }
    
    return exports;
};
function get(option){
    if (_definition[option] !== undefined){
        return _definition[option].value;
    } else {
        throw "unspecified option: " + option;
    }
...
function set(option, value){
    if (_definition[option] !== undefined){
        _definition[option].value = value;
    } else {
        throw "unspecified option: " + option;
    }
...
function size(){
    return _.where(_definition, { group: groupString() }).length;
    return exports;
}
