...
Config.prototype.get = function(option){
    if (_definition[option] !== undefined){
        ...
        _.each(_definition, function(value, key){
            if 
        })
    }
};
...
var _currentGroup = _definition;
Config.prototype.group = function(name){
    if (_definition[name] === undefined){
        _definition[name] = {};
    }
    _currentGroup = _definition[name];
    return this;
};
Config.prototype.subgroup = function(name){
    if (_currentGroup[name] === undefined){
        _currentGroup[name] = {};
    }
    _currentGroup = _currentGroup[name];
    return this;
};
